...
company = user_data.json()["company"]
bio = user_data.json()["bio"]
print(f"Your GitHub's username: {username}")
print(f"Your GitHub's username: {name}")
print(f"Your GitHub's email: {email}")
print(f"Your GitHub's company: {company}")
print(f"Your GitHub's bio: {bio}")